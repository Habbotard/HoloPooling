...
namespace Holo
{
    ...
    public class Eucalypt
    {
        ...
        private static void Boot()
        {
            ...
            Out.WriteLine("Holo TDbP EXTREME edition Hotel Emulator - Startup Time: " + _TST.TotalMilliseconds.ToString() + ".");
        ...
        private static void resetDynamics()
        {
            ...
            Out.WriteLine("Connections - (Reset!)");
            Out.WriteLine("Counters - (Reset!).");
        ...
        private static void monitorServer()
        {
            while(true)
            {
                ...
                Console.Title = "Holo Hotel Emulator: | Connected Users: " + onlineCount + " | Loaded Rooms: " + roomCount + " | RAM usage: " + memUsage + "KB | Max Connections: " + peakOnlineCount+" | SQL Starvation: " +starvationNumber+ " | SQL Connections: " + dbManager.databaseClients;
                using (DatabaseClient dbClient = dbManager.GetClient())
                {
